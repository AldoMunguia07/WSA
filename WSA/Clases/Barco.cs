...
namespace WSA.Clases
{
    class Barco
    {
        ...
        //METODOS
        public void MostrarBarcos(DataGridView dataGrid)
        {
            ...
            try
            {
                ...
                SqlCommand sqlCommand = new SqlCommand("sp_Barco", conexion.sqlConnection);
        ...
        public void BuscarBarco(DataGridView dataGrid, string valorBuscado)
        {
